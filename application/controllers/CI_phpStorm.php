 ...
 * @property CI_Controller $this	              This class object is the super class that every library in.<br />CodeIgniter will be assigned to.
 ...
 * @property ModelInfraccion $infraccion
 * @property  ModelVehiculos $vehiculos
 * @property ModelPersonas $personas
 * @property ModelUsuarios $usuarios
 * @property ModelLeyes $leyes
 *
 */
